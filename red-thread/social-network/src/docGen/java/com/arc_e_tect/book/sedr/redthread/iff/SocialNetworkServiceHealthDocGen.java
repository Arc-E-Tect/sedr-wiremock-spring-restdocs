...
@Slf4j
@NoArgsConstructor
public class SocialNetworkServiceHealthDocGen extends DocumentationGenerator {
    ...
    @Test
    void retrieveSocialNetworkHealthInformation() {
        this.docGeneratorClient.get().uri("/actuator/health")
                .accept(MediaType.APPLICATION_JSON)
                .exchange()
                .expectStatus().isOk()
                .expectBody()
                .consumeWith(WireMockWebTestClient.verify())
                .consumeWith(document("{class-name}/{method-name}/get-health"));
    }
}
